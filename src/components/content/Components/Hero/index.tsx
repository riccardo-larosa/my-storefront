...
const HeroFC: React.FC<HeroProps> = ({ title, description, image, buttonLabel, buttonLink, padding }) => {
    return ( 
            // <div className={`pt-${padding} pb-${padding}`}>
            //     <div id="hero-image" className="bg-cover bg-center absolute inset-0 max-w-fit"
            //         style={{ backgroundImage: `url(${image})` }} />
            //     <div className="absolute inset-0 max-w-fit bg-gradient-to-l from-transparent to-[#f7faff] via-[#f7faff]/50"></div>
            //     <div id="hero-content" className="relative z-10 max-w-1/2">
            //         <h1>{title}</h1>
            //         <p>{description}</p>
